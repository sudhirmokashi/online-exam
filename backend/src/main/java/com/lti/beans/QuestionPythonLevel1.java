...
@Entity
@Table(name="QUESTION_PYTHON_LEVEL_1")
public class QuestionPythonLevel1 implements Question{
	...
	public QuestionPythonLevel1(int questionId, String questionDesc, String questionOptionA, String questionOptionB,
